...
void test_basic()
{
  ObjectPoolTestHarness<int> test( "basic", []() { return 0; }, []( int& ) {} );
...
void test_pre_allocated()
{
  ObjectPoolTestHarness<string> test(
    "pre_allocated", []() { return string(); }, []( string& s ) { s.clear(); }, 3 );
...
void test_max_size()
{
  ObjectPoolTestHarness<double> test( "max_size", []() { return 0.0; }, []( double& ) {}, 0, 2 );
...
{
  int reset_count = 0;
  ObjectPoolTestHarness<int> test( "resetter", []() { return 42; }, [&reset_count]( int& ) { reset_count++; } );
